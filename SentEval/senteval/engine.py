...
from senteval.sts import JACSTSEval, JSTSEval, STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STSBenchmarkEval, SICKRelatednessEval, STSBenchmarkFinetune
...
class SE(object):
    ...
    def eval(self, name):
        ...
        if name == 'CR':
            ...
            self.evaluation = JSTSEval(tpath + '/downstream/STS/JSTS', seed=self.params.seed)  
        elif name == 'JACSTS':
            self.evaluation = JACSTSEval(tpath + '/downstream/STS/JAC-STS', seed=self.params.seed)       
